pipeline {
    ...
    parameters {
        ...
        string(name: 'instance_capacity_types_spot', defaultValue: 'ON_DEMAND', description: 'spot instance')
        ...
        string(name: 'k8s_version', defaultValue: '1.28', description: 'eks version')
        string(name: 'instance-type-on-demand', defaultValue: 'r5a.large', description: 'on demand instance type')
        string(name: 'instance-type-spot', defaultValue: 'r5a.large', description: 'spot instance type')
    ...
    stages {
        ...
        stage('kube bench and sc0re genrator') {
            steps {
                script {
